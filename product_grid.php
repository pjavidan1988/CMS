			      	...
			      	<div class="site-header__cart item-dropdown">
				        ...
				        <div class="widget_shopping_cart_content  content-dropdown">
							 <div class="cart_list ">
							  ...
							  <a href="checkout.html" class="btn check-out btn-primary btn-normal pull-left">پرداخت</a>
						 	 </p>
						</div>
			        </div>
		        </div>
					...
					<ul class="main-nav nav navbar-nav navbar-right">
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
				            	<li><a href="../v2/index.html">صفحه اصلی 2</a>
				            	</li>
				            	<li><a href="../v3/index.html">صفحه اصلی 3</a></li>
			            	</ul>
						</li>
			         	<li class="dropdown">
			         		<a href="product_grid.php">محصولات</a>
			         		<ul class="dropdown-menu">
				 				...
				 				<div class="product-block" data-publish-date="">
									<div class="product-image product_1">
										...
										<div class="tawcvs-swatches color_selector" data-attribute_name="attribute_pa_color">
                        					<span class="swatch swatch-color swatch-blue" title="آبی" data-value="blue">آبی</span>
                        					<span class="swatch swatch-color swatch-orange" title="نارنجی" data-value="orange">نارنجی</span>
                        					<span class="swatch swatch-color swatch-purple" title="بنفش" data-value="purple">بنفش</span>
                        				</div>
									...
									<div class="product-meta">
										...
										<div class="product-price">
											<span class="amout">
												<span class="money" data-currency-usd="$700.00">700 ه ت</span>
											</span>
				 			...
				 			<div class="col-md-4 col-sm-6">
				 				<div class="product-block" data-publish-date="">
									<div class="product-image product_2">
										...
										<div class="tawcvs-swatches color_selector" data-attribute_name="attribute_pa_color">
                        					<span class="swatch swatch-color swatch-red" title="قرمز" data-value="red">آبی</span>
                        					<span class="swatch swatch-color swatch-green" title="سبز" data-value="green">سبز</span>
                        					<span class="swatch swatch-color swatch-purple" title="قرمز" data-value="purple">قرمز</span>
                        				</div>
										<div class="product-actions">
											<a href="#" data-id="" class="btn wishlist product-quick-whistlist" title="اضافه به لیست مورد علاقه">
											<i class="fa fa-heart-o"></i>
				 			...
				 			<div class="col-md-4 col-sm-6">
				 				<div class="product-block" data-publish-date="">
									...
									<div class="product-meta">
										...
										<div class="product-price">
											<span class="amout">
												<span class="money" data-currency-usd="$900.00">900 ه ت</span>
											</span>
											<a href="product_single.html" class="add_to_cart_button">اضافه به سبد خرید</a>
										</div>
				 					...
				 					<div class="row">
						 				...
						 				<div class="col-md-8 col-lg-8 col-sm-8">
											<div class="product-meta">
												...
												<div class="product-price">
													<span class="amout">
														<span class="money" data-currency-usd="$700.0">700 ه ت</span>
													</span>
												</div><!-- /.product-price -->
												<div class="excerpt">
				 					...
				 					<div class="row">
						 				...
						 				<div class="col-md-8 col-lg-8 col-sm-8">
											<div class="product-meta">
												...
												<div class="product-price">
													<span class="amout">
														<span class="money" data-currency-usd="120 ه ت ">120 ه ت </span>
													</span>
												</div><!-- /.product-price -->
												<div class="excerpt">
							                        حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.               
